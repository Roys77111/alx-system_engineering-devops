...
approximately 00:07 West African Time (WAT), an outage occurred on an isolated
Ubuntu 20.04 container running an Nginx web server. GET requests on the server led to
...
2. Looked in the `sites-available` folder of the `/etc/nginx/` directory. Determined that
...
[0-strace_is_your_friend.pp](https://github.com/Roys77111/alx-system_engineering-devops/blob/master/0x17-web_stack_debugging_3/0-strace_is_your_friend.pp)
